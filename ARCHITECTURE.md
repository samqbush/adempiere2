...
|---|---|---|
| `main.yml` | Push and pull request to `master`, `develop`, and bugfix/feature/hotfix/test branch patterns | Runs the guarded distribution, installed-product, Phase 4 API, Phase 5 frozen-oracle, Phase 5c packaging/rollback, and separate Phase 5d database-neutral and PostgreSQL-backed modern-web gates on JDK 21. Phase 5d failure uploads include compile, WAR, browser, full-row database-effect, coexistence, and rollback evidence (`.github/workflows/main.yml`). |
...
including the Phase 5d modern web `:zkwebui` project.
