...
| `./gradlew phase5g0FinalVerification --dependency-verification=strict` | Database-neutral Phase 5g-0 discovery gate and current head of the phase-gate chain: generate-then-validate of the three reviewed Phase 5g inventories with an exact row and preamble comparison and a closed contract directory listing, chaining `phase5fFinalVerification`. | `gradle/phase5/phase5g-inventories.gradle`, `scripts/phase5/generate-phase5g-inventories.py`, `scripts/phase5/validate-phase5g-inventories.py`. |
